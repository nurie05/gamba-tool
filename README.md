### Operon Finder
A tool coded in **_Rust_** to search for operons among annotated transcripts.
It requires a GTF files with the values of 'cov' and 'fpkm', as are used for operon filtering.
